...
def column(
    ...
    **kwargs: Any,
    ...
    if default_factory is not None:
        column_kwargs["default_factory"] = default_factory
    ...
    if init is not None:
        column_kwargs["init"] = init
    if repr is not None:
        column_kwargs["repr"] = repr
    if compare is not None:
        column_kwargs["compare"] = compare
    if hash is not None:
        column_kwargs["hash"] = hash
    if kw_only is not None:
        column_kwargs["kw_only"] = kw_only
    if sort_order is not None:
        column_kwargs["sort_order"] = sort_order
    if info is not None:
